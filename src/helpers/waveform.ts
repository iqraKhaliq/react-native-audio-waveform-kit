...
export const downsampleWithPeaks = (data: number[], targetCount: number): number[] => {
...
export const amplitudeToBarHeight = (amp: number) => {
...
export const generateBars = (amps: number[]) => {
